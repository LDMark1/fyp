...
const HCWA_Assigned_Vaccines = (props) => {
  ...
  const columns: GridColDef[] = [
    ...
    { field: "HCWA_fullName", headerName: "Healthcare worker Name", flex:1, editable: true, valueParser: (value: GridCellValue, params: GridCellParams) => {
      console.log(value);
    } },
    {
      field: "vaccineName",
  ...
  return (
    ...
    <Box m="20px">
      <Header
        title="Vaccines Assigned to Healthcare Worker Admins"
        subtitle="List of Vaccines Assigned to Healthcare Worker Admins"
      />
      <Box
        m="40px 0 0 0"
        height="75vh"
...
export default HCWA_Assigned_Vaccines;
