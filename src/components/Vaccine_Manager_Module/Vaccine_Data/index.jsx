...
const baseURL = "http://127.0.0.1:8000/savevac";
...
const VaccineData = () => {
  ...
  const columns: GridColDef[] = [
    ...
    { field: "vaccineName", headerName: "Vaccine Name", editable: true, valueParser: (value: GridCellValue, params: GridCellParams) => {
    ...
    },
    {
      ...
      headerName: "Vaccine Description",
      flex: 1,
      editable: true,
      valueParser: (value: GridCellValue, params: GridCellParams) => {
        headerName = ('updatevaccinedescription');
        updateValue = value;
      }
    },
  ];
